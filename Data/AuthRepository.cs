...
namespace DatingApp.API.Data
{
  public class AuthRepository : IAuthRepository
  {
    ...
    {
        using (var hmac = new System.Security.Cryptography.HMACSHA512(passwordSalt)) {  // Uses supplied salt.
            var computedHash = 
                        hmac.ComputeHash(System.Text.Encoding.UTF8.GetBytes(password)); // Hash with supplied salt.
